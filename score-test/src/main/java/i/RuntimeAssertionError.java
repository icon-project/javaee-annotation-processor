...
public class RuntimeAssertionError extends RuntimeException {
    ...
    public static RuntimeAssertionError unexpected(Throwable t) {
        return new RuntimeAssertionError("Unexpected Throwable", t);
    }
    ...
    public static RuntimeAssertionError unreachable(String message) {
        return new RuntimeAssertionError("Unreachable code reached: " + message);
    }
    ...
    public static RuntimeAssertionError unimplemented(String message) {
        return new RuntimeAssertionError("Unimplemented path: " + message);
    }
